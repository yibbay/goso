		...
		handleClick:function(e){
			...
			$.ajax({
				...
				success:function(data){
					...
					ReactDOM.render(React.createElement(CompDetail, null),document.body);
				}
			})
...
/***/ function(module, exports, __webpack_require__) {
	...
	var CompDetail = React.createClass({displayName: "CompDetail",
	    ...
	    render: function () {
	        ...
	        return (
	            React.createElement("div", {style: this._css.yellow}, 
	                ...
	                React.createElement("div", {className: "count-down"}, 
	                    "距离结束时间: ", React.createElement("span", null)
	                ), 

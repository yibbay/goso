...
/***/ function(module, exports, __webpack_require__) {
	...
	var CompList = __webpack_require__(171);
	var CompBanner = __webpack_require__(174);
	var CompList = __webpack_require__(171);
		...
		handleChange:function(e){
			...
			$.ajax({
				...
				success:function(data){
					...
					if(_text===''){
						ReactDOM.render(React.createElement(CompBanner, null),document.querySelector('#banner'));
						ReactDOM.render(React.createElement(CompList, null),document.querySelector('#list'))
					}else{
						ReactDOM.unmountComponentAtNode(document.querySelector('#banner'));
					    ReactDOM.unmountComponentAtNode(document.querySelector('#list'));
					    
					    ReactDOM.render(React.createElement(CompList, {name: data}),document.querySelector('#list'))
					}
	            ...
	            React.createElement("div", null, 
	                React.createElement("section", {style: _style.search}, 
	                    React.createElement("div", {style: _style.searchbox}, 
	                        ...
	                        React.createElement("input", {onChange: this.handleChange, style: _style.searchinput, type: "text", placeholder: "请输入搜索内容"})
	                    )
	                )
	            )
	        );
...
/***/ function(module, exports, __webpack_require__) {
	...
	var React = __webpack_require__(1);
	var ReactDOM = __webpack_require__(38);
	var CompDetail = __webpack_require__(172);
	...
	var ComponentList = React.createClass({displayName: "ComponentList",
	    ...
	    render: function () {
	        ...
	        lists.forEach(function (value, index) {
	            temp.push(React.createElement(ComponentListItem, React.__spread({},  value)));
	            //console.log(value)
	        });
	        return (
	            React.createElement("div", {style: _css.paddingbottom}, 
	...
	var ComponentListItem = React.createClass({displayName: "ComponentListItem",
		handleClick:function(e){
			...
			$.ajax({
				...
				success:function(data){
					//console.log(data[0]);
					ReactDOM.render(React.createElement(CompDetail, React.__spread({},  data[0])),document.body);
				}
			})
	    ...
	    render: function () {
	        ...
	        return (
	            React.createElement("div", {style: _css.listitem, onClick: this.handleClick}, 
	                React.createElement("div", {style: _css.listimg}, 
	                    React.createElement("img", {style: _css.img, src: this.props.goodsListImg})
	                ), 
	                React.createElement("div", {style: _css.itemdesc}, 
	                    React.createElement("div", {style: _css.goodsName}, name), 
	                    React.createElement("div", {style: _css.goodsPrice}, "￥", React.createElement("span", null, this.props.price)), 
	                    React.createElement("div", {style: _css.goodsDiscount}, this.props.discount), 
...
/***/ function(module, exports, __webpack_require__) {
	...
	var React = __webpack_require__(1);
	var ReactDOM = __webpack_require__(38);
	var CompDetailFooter = __webpack_require__(173);
	var CompLayout = __webpack_require__(168);



	//商品详情组件布局开始
	var CompDetail = React.createClass({displayName: "CompDetail",
	    handleClick:function(){

	        ReactDOM.unmountComponentAtNode(document.body);

	        ReactDOM.render(React.createElement(CompLayout, null),document.body);
	    ...
	    render: function () {
	        ...
	        return (
	            React.createElement("div", null, 
	                React.createElement("div", {style: this._css.yellow, className: "detail-header"}, 
	                    React.createElement("div", {onClick: this.handleClick, style: this._css.left}, 
	                        React.createElement("img", {style: this._css.leftimg, src: "img/jian.png", alt: ""})
	                    ), 
	                    React.createElement("h4", {style: this._css.h4}, "商品介绍"), 
	                    React.createElement("div", {style: this._css.right}, 
	                        React.createElement("img", {style: this._css.rightimg, src: "img/share.png", alt: ""})
	                    )
	                ), 
	                React.createElement("div", {style: this._css.countdown, className: "count-down"}, 
	                    React.createElement(CompDetailTimeDown, null)
	                ), 
	                React.createElement("div", {className: "goods-detail"}, 
	                    React.createElement(CompDetailItem, {data: this.props})
	                ), 
	                React.createElement("div", null, 
	                    React.createElement(CompDetailFooter, null)
	                )
	            )
	        )
	    }
	...
	//商品详情图片子组件开始
	var CompDetailItem = React.createClass({displayName: "CompDetailItem",

	    render: function () {
	        //console.log(this.props.data);
	        return (
	            React.createElement("div", null, 
	                React.createElement("div", {style: this.CSS.gImgContainer}, 
	                    React.createElement("img", {style: this.CSS.goodsImg, src: this.props.data.goodsListImg, alt: ""})
	                ), 
	                React.createElement("div", {style: this.CSS.gImgContainer}, 
	                    React.createElement("img", {className: "img-goods", src: "img/31.png", alt: ""})
	                ), 
	                React.createElement("div", {className: "goods-price"}, 
	                    React.createElement("span", null, "市场价："), 
	                    React.createElement("span", {style: this.CSS.spanDecoration}, "￥", this.props.data.price), "  ", 
	                    React.createElement("span", null, this.props.data.discount), "折   ", 
	                    React.createElement("span", null, this.props.data.buynumber), "人购买"
	                )
	            )
	        )
	    }
	...
	//商品详情倒计时子组件开始
	var CompDetailTimeDown = React.createClass({displayName: "CompDetailTimeDown",
	    getInitialState: function () {
	        var date = new Date();
	    ...
	    render: function () {
	        ...
	        return (
	            React.createElement("div", null, 
	                "距离结束时间: ", React.createElement("span", null, this.state.timedown)
	            )
	        )
	    }
...
/***/ function(module, exports, __webpack_require__) {
	...
	var CompDetailFooter = React.createClass({displayName: "CompDetailFooter",
	    render: function () {
	        return (
	            React.createElement("div", {style: this.CSS.flex}, 
	                React.createElement("div", {style: this.CSS.item}, 
	                    "介绍"
	                ), 
	                React.createElement("div", {style: this.CSS.item}, 
	                    "详情"
	...
	var ComponentBanner = React.createClass({displayName: "ComponentBanner",
	    ...
	    render: function () {
	        ...
	        this.state.banner.forEach(function(value,index){
	            //console.log(value)
	            temp.push(React.createElement(ComponentBannerItem, React.__spread({},  value)))
	        });
	        return (
	    ...
	    render: function () {
	        ...
	        return (
	            React.createElement("div", {className: "swiper-slide"}, 
	                React.createElement("img", {style: img, className: "swiper-img", src: prop})
	            )
	        )
	    },
	    componentDidMount:function(){
...
/***/ function(module, exports, __webpack_require__) {
	...
	var ComponentBanner = __webpack_require__(174);
	var ComponentList = __webpack_require__(171);
	var NewComponent = __webpack_require__(176);
